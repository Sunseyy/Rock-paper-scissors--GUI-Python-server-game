...
def redrawWindow(win, game, p):
    ...
    if not(game.connected()):
        ...
        font = pygame.font.SysFont("Chalkboard", 60)
        text = font.render("Your Move", 1, (255, 192, 203))
...
btns = [Button("Rock", 50, 500, (255, 51, 153)), Button("Scissors", 250, 500, (204, 153, 255)), Button("Paper", 450, 500, (153, 153, 255))]
def main():
    run = True
    ...
    while run:
        ...
        if game.bothWent():
            ...
            font = pygame.font.SysFont("Chalkboard", 90)
